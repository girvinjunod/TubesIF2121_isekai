...
help :-
  ...
  write('% 7.  teleport         : Teleport ke salah satu tempat \'special\' (Q, S, B)         %\n'),
  write('% 8.  help             : menampilkan segala bantuan                                  %\n'),
  write('%                                                                                    %\n'),
  write('% 9.  use(Nama)        : Menggunakan item dengan nama item `Nama`                    %\n'),
  write('% 10. inventory        : Menuliskan isi inventory (inventory max 100)                %\n'),
  write('% 10. store            : Membuka menu store (hanya bisa di store (S))                %\n'),
  write('% 11. sell             : Menjual barang di inventory (hanya bisa di store (S))       %\n'),
  write('% 12. drop(N)          : Membuang barang dengan nama N dari inventory                %\n'),
  write('% 13. drop(N, Q)       : Membuang sekaligus Q item dengan nama N dari inventory      %\n'),
  write('% 14. equip(N)         : Meng-equip armor atau senjata N dari inventory              %\n'),
  write('% 15. unequip(N)       : Melepas armor atau senjata N dari badan                     %\n'),
