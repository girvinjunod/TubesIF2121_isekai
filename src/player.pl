...
die :-
	...
	retractall(weaponequipped(_)),
	retractall(armorequipped(_)),
	setState(not_started),nl, sleep(2),
	write('Kamu terjatuh di tengah pertempuran, seiring kamu ditelan kegelapan, kamu melihat sang shopkeeper tersenyum...'), nl,nl, sleep(3),
	write('Kamu mencoba untuk bergerak namun tidak bisa, karena kamu sudah tewas...'),nl,sleep(3),nl,nl,
...
die :-
  ...
  retractall(armorequipped(_)),
  setState(not_started), nl, sleep(2),
  write('Kamu terjatuh di tengah pertempuran, seiring kamu ditelan kegelapan, kamu mendengar teriakan minta tolong...'), nl,nl, sleep(3),
  write('Sayangnya, kamu tidak dapat bergerak, karena kamu sudah tewas...'),sleep(3), nl,
  nl,nl, 
  write('------------------------------------------------------GAME OVER------------------------------------------------------\n'),
  reset, !.
