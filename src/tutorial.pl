tpb(X) :-
    ...
    write('Monster-monster tubes inilah yang sedang meneror dunia jurusan dan alasan mengapa kamu disummon ke sini.\n'),
    nl, sleep(3),
    write('Kamu sebagai mahasiswa IF ITB pastinya sudah terbiasa dan jago dalam mengalahkan tubes.\n'),sleep(2),nl,
...
battleTutorial :-
  ...
  setState(tutorial),
  asserta(special_cooldown(0)),sleep(2),nl,
  battleStats,sleep(2),nl,
  help, nl,nl,
